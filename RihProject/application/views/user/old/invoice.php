	...
	<div class="padding-md">
		<div class="clearfix">
			...
			<div class="pull-right" style="text-align:right; line-height:12px;">
				...
				?>
				<h4 style="line-height:10px;"><strong>Voucher No.<?php echo $idvoucher; ?></strong></h4>
		...
		<div class="clearfix">
			...
			<div class="pull-right text-right">
				...
				<address style="line-height:14px;"> 
					<strong><?php echo $personal_data->nombres; ?> <?php echo $personal_data->apellido_paterno; ?> <?php echo $personal_data->apellido_materno; ?></strong><br>
					<?php echo $personal_data->rut; ?><br> 
					<?php echo $personal_data->ciudad; ?>, CHILE<br> 					
					<?php echo $personal_data->correo; ?><br> 
					<abbr title="Fono">P:</abbr><?php echo $personal_data->telefono_personal; ?><br> 
				</address> 
			</div>
		</div>
