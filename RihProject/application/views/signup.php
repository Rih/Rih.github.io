			...
			<div class="sign-in-wrapper">
				<div class="sign-in-inner">
					<div class="login-brand text-center">
						...
						<img src="<?php echo base_url();?>template/theme/img/account-text-create.png">
					</div>
					<?php include 'page_info.php'; ?>
					<?php echo form_open('?account/create_account',array('id' => 'formValidate1', 'class' => 'login'));?>   
						<p>					      
					    ...
					    <a href="<?php echo base_url();?>" class="btn btn-success input-sm">Log in here!</a>
