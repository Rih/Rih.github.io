...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('B2', '#')
            ->setCellValue('C2', 'ID Venta')
            ->setCellValue('D2', 'ID Voucher')
            ->setCellValue('E2', 'Fecha Venta')
            ->setCellValue('F2', 'Codigo Rifa')            
...
foreach ($rifas_vendidas as $row){  
    ...
    $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('C'.$number, $row->idventa)
        ->setCellValue('D'.$number, $idvoucher)
        ->setCellValue('E'.$number, $row->fecha_venta)
        ->setCellValue('F'.$number, $row->rifa_codigo)        
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Rifas Vendidas');
...
header('Content-Disposition: attachment;filename="Rifa.xls"');
